...
function SSLChecker() {
  ...
  const saveMonitoring = async () => {
    ...
    try {
      ...
      alert(
        "SSL monitoring added successfully"
      );
        ...
        <div className="mt-10">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5 mb-8">
            ...
            <button
              ...
              className="bg-cyan-500 hover:bg-cyan-600 text-black px-8 py-4 rounded-2xl font-bold transition duration-300 cursor-pointer"
            >
